...
import { useSSRContext, ref, computed, reactive, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, withDirectives, openBlock, createBlock, Fragment, renderList } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrGetDirectiveProps, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderSlot } from 'vue/server-renderer';
import { r as required, f as faceModelImagesCount, n as notification, u as useValidateForm } from './element.utils-D43vSFwO.mjs';
                        ...
                        default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                          if (_push5) {
                            ...
                            _push5(ssrRenderComponent(_component_el_col, {
                              ...
                              default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                if (_push6) {
                                  _push6(`<div class="bg-black app-base-padding app-base-border-radius"${_scopeId5}><div class="my-faces-create-example-images"${_scopeId5}><div${_scopeId5}><img${ssrRenderAttr("src", _imports_7)}${_scopeId5}></div><div${_scopeId5}><img${ssrRenderAttr("src", _imports_8)}${_scopeId5}></div><div${_scopeId5}><img${ssrRenderAttr("src", _imports_9)}${_scopeId5}></div></div><div class="my-faces-create-example-info"${_scopeId5}><p class="card-item__title"${_scopeId5}>\u{1F6AB} Bad Photos</p><span class="card-item__description"${_scopeId5}> Avoid group photos. Ensure images are sharp, well-lit without shadows, and keep angles natural and straightforward. </span></div></div>`);
                                } else {
                                  return [
                                    createVNode("div", { class: "bg-black app-base-padding app-base-border-radius" }, [
                                      createVNode("div", { class: "my-faces-create-example-images" }, [
                                      ...
                                      createVNode("div", { class: "my-faces-create-example-info" }, [
                                        createVNode("p", { class: "card-item__title" }, "\u{1F6AB} Bad Photos"),
...
//# sourceMappingURL=create-B0hvYHUF.mjs.map
