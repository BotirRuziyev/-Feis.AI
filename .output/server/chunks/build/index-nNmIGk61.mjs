import { defineComponent, inject, reactive, ref, h, provide, computed, watch, cloneVNode, Fragment, useSSRContext, withCtx, createVNode, openBlock, createBlock, renderList, toDisplayString, createTextVNode, mergeProps } from 'vue';
import { _ as __nuxt_component_0 } from './nuxt-link-DM--a9B3.mjs';
import { _ as _export_sfc, m as useRoute, e as ElButton, k as useRuntimeConfig } from './server.mjs';
import { ssrRenderComponent, ssrRenderList, ssrRenderStyle, ssrRenderClass, ssrInterpolate, ssrRenderAttrs, ssrRenderAttr } from 'vue/server-renderer';
import { _ as _imports_0, a as _imports_1 } from './virtual_public-lfYRWJ5S.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
          ...
          _push2(ssrRenderComponent(_component_Slide, {
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              ...
              if (_push3) {
                ...
                _push3(`<!--]--></div><h2 class="carusel-item-title" data-v-c9b82366${_scopeId2}>${ssrInterpolate(carouselItem.title)}</h2><p class="carusel-item-description" data-v-c9b82366${_scopeId2}>${(_a = carouselItem.text) != null ? _a : ""}</p></div></div>`);
              } else {
                return [
                  createVNode("div", {
        ...
        ssrRenderList($setup.carouselItems, (carouselItem, index2) => {
          _push2(ssrRenderComponent(_component_Slide, {
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              var _a;
              if (_push3) {
                _push3(`<div class="signup-section-mobile-carousel-item" data-v-c9b82366${_scopeId2}><div class="signup-section-mobile-carousel-item-img" style="${ssrRenderStyle({ background: "url(" + carouselItem.img + ")" })}" data-v-c9b82366${_scopeId2}></div><div class="signup-section-mobile-carousel-item-text" data-v-c9b82366${_scopeId2}><div class="signup-section-login-logo" data-v-c9b82366${_scopeId2}>Feis.AI</div><h2 class="carusel-item-title" data-v-c9b82366${_scopeId2}>${ssrInterpolate(carouselItem.title)}</h2><p class="carusel-item-description" data-v-c9b82366${_scopeId2}>${(_a = carouselItem.text.replace("<br>", "")) != null ? _a : ""}</p><div class="signup-section-mobile-item-carousel-navigation" data-v-c9b82366${_scopeId2}><!--[-->`);
                ssrRenderList($setup.carouselItems, (carouselItem2, index22) => {
                  _push3(`<span class="${ssrRenderClass({ active: $setup.currentSlide === index22 })}" data-v-c9b82366${_scopeId2}></span>`);
                });
                _push3(`<!--]--></div>`);
...
//# sourceMappingURL=index-nNmIGk61.mjs.map
