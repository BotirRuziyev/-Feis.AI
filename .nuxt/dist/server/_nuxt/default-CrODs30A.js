import { mergeProps, useSSRContext, withCtx, createVNode, createTextVNode, toDisplayString, defineComponent, renderSlot } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderSlot } from "vue/server-renderer";
import { _ as _export_sfc, u as useAuthStore, m as useRoute } from "../server.mjs";
import { _ as __nuxt_component_0$1 } from "./nuxt-link-DM--a9B3.js";
...
import { _ as _imports_6 } from "./virtual_public-DI5z1i-1.js";
import "hookable";
import "ofetch";
import "unctx";
import "h3";
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_link = __nuxt_component_0$1;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "dashboard-footer" }, _attrs))}><div><span>© Feis AI, 2024</span></div><div>`);
  _push(ssrRenderComponent(_component_nuxt_link, { to: { name: "contactSupport" } }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Contact Support`);
...
//# sourceMappingURL=default-CrODs30A.js.map
